                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul class="language-dropdown">
                                    <li>
                                        <a href="#"><img src="nest-frontend/assets/imgs/theme/flag-fr.png" alt="" />Français</a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="nest-frontend/assets/imgs/theme/flag-dt.png" alt="" />Deutsch</a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="nest-frontend/assets/imgs/theme/flag-ru.png" alt="" />Pусский</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="language-dropdown">
                                    <li>
                                        <a href="#"><img src="nest-frontend/assets/imgs/theme/flag-fr.png" alt="" />INR</a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="nest-frontend/assets/imgs/theme/flag-dt.png" alt="" />MBP</a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="nest-frontend/assets/imgs/theme/flag-ru.png" alt="" />EU</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
            ...
            <div class="header-wrap header-space-between position-relative">
                ...
                <div class="header-nav d-none d-lg-flex">
                    ...
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                        <nav>
                            <ul>
                                <li class="hot-deals"><img src="nest-frontend/assets/imgs/theme/icons/icon-hot-white.svg" alt="hot deals" /><a href="shop-grid-right.html">Hot Deals</a></li>
                                <li>
                ...
                <div class="hotline d-none d-lg-flex">
                    <img src="nest-frontend/assets/imgs/theme/icons/icon-headphone-white.svg" alt="hotline" />
                ...
                <div class="carausel-10-columns" id="carausel-10-columns">
                    <div class="card-2 bg-9 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="nest-frontend/assets/imgs/shop/cat-13.png" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="nest-frontend/assets/imgs/shop/cat-12.png" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="nest-frontend/assets/imgs/shop/cat-11.png" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="nest-frontend/assets/imgs/shop/cat-9.png" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-13 wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="nest-frontend/assets/imgs/shop/cat-3.png" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-14 wow animate__animated animate__fadeInUp" data-wow-delay=".6s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="nest-frontend/assets/imgs/shop/cat-1.png" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-15 wow animate__animated animate__fadeInUp" data-wow-delay=".7s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="nest-frontend/assets/imgs/shop/cat-2.png" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".8s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="nest-frontend/assets/imgs/shop/cat-4.png" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".9s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="nest-frontend/assets/imgs/shop/cat-5.png" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay="1s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="nest-frontend/assets/imgs/shop/cat-14.png" alt="" /></a>
                        </figure>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="banner-img style-6 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <img src="nest-frontend/assets/imgs/banner/banner-16.png" alt="" />
                        <div class="banner-text">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="banner-img style-6 wow animate__animated animate__fadeInUp" data-wow-delay="0.2s">
                        <img src="nest-frontend/assets/imgs/banner/banner-17.png" alt="" />
                        <div class="banner-text">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="banner-img style-6 wow animate__animated animate__fadeInUp" data-wow-delay="0.4s">
                        <img src="nest-frontend/assets/imgs/banner/banner-18.png" alt="" />
                        <div class="banner-text">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="banner-img style-6 wow animate__animated animate__fadeInUp" data-wow-delay="0.6s">
                        <img src="nest-frontend/assets/imgs/banner/banner-19.png" alt="" />
                        <div class="banner-text">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="position-relative newsletter-inner">
                        ...
                        <img src="nest-frontend/assets/imgs/banner/banner-9.png" alt="newsletter" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section-padding footer-mid">
        <div class="container pt-15 pb-20">
            ...
            <div class="footer-link-widget widget-install-app col wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                ...
                <img class="" src="nest-frontend/assets/imgs/theme/payment-method.png" alt="" />
            </div>
        </div>
    </section>
